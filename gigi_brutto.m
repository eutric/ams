...
theta1_v=linspace(0,pi/8,2);
theta2_v=linspace(0,pi/8,2);
om_v=linspace(0,pi/8,2);
figure;
...
for theta1=theta1_v
    for theta2=theta2_v
        for om=om_v
            [O_t] = O_tfun(O_start,O_end,theta1,theta2,om, [0,0]);
            plotOrbit(O_t,O_t.th_t(1),O_t.th_t(2),0.1,'--')
        end
    end
end
